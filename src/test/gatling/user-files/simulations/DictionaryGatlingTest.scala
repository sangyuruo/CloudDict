...
/**
 * Performance test for the Dictionary entity.
 */
class DictionaryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Dictionary entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all dictionaries")
            .get("/emclouddict/api/dictionaries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created dictionary")
                .get("/emclouddict${new_dictionary_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created dictionary")
            .delete("/emclouddict${new_dictionary_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
