...
class DictionaryclassifyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Dictionaryclassify entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "dictCode":"SAMPLE_TEXT", "dictClassifyCode":"0", "dictClassifyValue":"SAMPLE_TEXT", "parentClassifyCode":"0", "sort":"0", "enable":null, "remark":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
